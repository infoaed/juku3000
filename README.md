...
* [MAME](http://adb.arcadeitalia.net/dettaglio_mame.php?game_name=juku) (töökorras emulaator, koodi leiab esialgu [siit](https://github.com/boamaod/mame) ja käiviamiseks [romi](mameroms) siit, mõne aja pärast eeldatavasti vaikimisi osa MAME paketist)
