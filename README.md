...
* [MAME](http://adb.arcadeitalia.net/dettaglio_mame.php?game_name=juku) (töökorras emulaator, mida saab [proovida ka veebis](https://infoaed.ee/juku), klahvistik on [siin](https://infoaed.ee/juku/layout.html) ja koodi leiab esialgu [siit](https://github.com/boamaod/mame), käivitamiseks vajalikud RomBios 3.43m ja JBASIC 1.1 ROMid [siit](mameroms), kood mõne aja pärast eeldatavasti vaikimisi [osa MAMEst](https://github.com/mamedev/mame/pull/9946))
