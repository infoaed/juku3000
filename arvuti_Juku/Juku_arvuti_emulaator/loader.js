...
(function (Promise) {
   ...
   function IALoader(canvas, game, callbacks, scale) {
     ...
     var get_js_url = function (js_filename) {
       console.log("HEIHEI", js_filename);
   ...
   function Emulator(canvas, callbacks, loadFiles) {
       ...
       loading.then(function (_game_data) {
              ...
              .then(function (game_files) {
                      ...
                      if (options.waitAfterDownloading) {
                        return new Promise(function (resolve, reject) {
                                             splash.setTitle("Alustamiseks klõpsa kuhugi! (laadimine kestab kuni 1 minut)");
              ...
              .then(function () {
                      ...
                      if (game_data.emulatorJS) {
                        splash.setTitle("Emulaatori käivitamine...");
                        splash.hide();
                        return attach_script("arvuti_Juku/Juku_arvuti_emulaator/" + game_data.emulatorJS);
                      } else {
     ...
     var drawsplash = function () {
       ...
       if (!splash.splashimg.src) {
         splash.splashimg.src = "arvuti_Juku/Juku_arvuti_emulaator/logo/emularity_color_small.png";
       }
     };
