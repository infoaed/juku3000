...
JUKU jaoks fundamentaalsel opsüsteemi tasemel lähtutakse CP/M-i [128-baidisest sektorisuurusest](https://en.wikipedia.org/wiki/CP/M#Basic_Input_Output_System), mis tähendab, et rajad on kattal jagatud 40 sektorisse, st iga rada on 40x128 = 5120 baiti. Füüsilisel JUKU flopil on rajad aga jagatud 10 sektorisse, millest lähtuvalt arvutatakse ja kirjutatakse sektorite vahele andmete kontrollsummad. See tähendab, et füüsilisel kettal on sektori suurus hoopis 512 baiti ehk raja maht 10x512 = 4x10x128 = 5120 baiti. Kuna andmete füüsiline _kodeerimine_ ja _dekodeerimine_ on [korraldatud riistvara tasemel](https://en.wikipedia.org/wiki/Modified_frequency_modulation#MFM_coding), -- st "[`Fdc 1793 on MBoard`](https://en.wikipedia.org/wiki/Western_Digital_FD1771)" --, siis võib füüsilise flopi omadusi üldiselt ignoreerida ja piirduda opsüsteemi tasmemel kättesaadava _andmete vorminguga_.
