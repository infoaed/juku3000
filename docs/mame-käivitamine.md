...
Alates [MAME versioonist 0.272](https://github.com/mamedev/mame/releases/tag/mame0272) on JUKU töökorras unarvara auväärses nimekirjas ning saad selle MAME emulaatoriga omaenda arvuti töölaual käima lasta (veebiversiooni leiad [siit](https://infoaed.ee/juku/)). Selleks tuleb:
